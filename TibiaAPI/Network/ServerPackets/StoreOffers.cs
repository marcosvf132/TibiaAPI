...
namespace OXGaming.TibiaAPI.Network.ServerPackets
{
    public class StoreOffers : ServerPacket
    {
        ...
        public List<Offer> SubOffers { get; } = new List<Offer>();
        ...
        public override void ParseFromNetworkMessage(NetworkMessage message)
        {
            ...
            SubOffers.Capacity = message.ReadUInt16();
            for (var i = 0; i < SubOffers.Capacity; ++i) {
                var offer = new Offer
                {
                    Name = message.ReadString(),
                    IsFeatured = WindowType == 3
        ...
        public override void AppendToNetworkMessage(NetworkMessage message)
        {
            ...
            for (var i = 0; i < count; ++i) {
                ...
                for (var j = 0; j < productCount; ++j) {
                    ...
                    } else if (subOffer.DisplayType == 1) { // mount id // mount id
            ...
            count = Math.Min(SubOffers.Count, ushort.MaxValue);
            message.Write((ushort)count);
            for (var i = 0; i < count; ++i) {
